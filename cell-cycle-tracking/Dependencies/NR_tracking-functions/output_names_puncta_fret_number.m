function [ names ] = output_names_puncta_fret_number( sigs,localbg,ring,punctacalc, punctaThresh, varThresh,fret)
...
if fret
    length = length+1;
    names(1:2,length) = {length; ['Fret mean']};
    length = length+1;
    names(1:2,length) = {length; ['Fret median']};
end
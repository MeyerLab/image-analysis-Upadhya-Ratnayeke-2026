...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% %% Paths
% s.experiment_name='F048-live';                % Experiment name
% s.image_drive = 'N:\F048-live\';    % Location of images base folder
...
% s.bgcmospath='';   % file location of bgcmos image or empty if subtracting constant 100(no bin)/400 (2x bin)
...
% s.register_exception = [1 2 3 4];        % If don't register images, manually put in sites to register
% s.blocksize = 10000;
% 
...
% s.nuc_dilate = [1.5 1 1 1]; %1 for nuclear signals 2 for cytoplasmic 
        ...
        for j = 1:length(s.signals)
            switch s.microscope
                ...
                case 'nikon'
                    ...
                    raw{j}(raw{j} == 0) = prctile(raw{j}(:),10);
            end
